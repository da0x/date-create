...
@interface CollectionViewDateLayout ()
...
@implementation CollectionViewDateLayout
{
...
- (void)setup
{
    self.itemInsets = UIEdgeInsetsMake(42.0f, 62.0f, 43.0f, 42.0f);
...
- (void)prepareLayout
{
    ...
    for (NSInteger section = 0; section < sectionCount; section++) {
        ...
        for (NSInteger item = 0; item < itemCount; item++) {
            ...
            itemAttributes.frame = [self frameForDateCardAtIndexPath:indexPath];
...
{
    return self.layoutInfo[swipeDateLayoutCell][indexPath];
}
...
- (CGRect)frameForDateCardAtIndexPath:(NSIndexPath *)indexPath
{
